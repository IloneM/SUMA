...
#TODO: compute stats
    ...
    while True:
        ...
        if not data:
            break
        ests = suma.Suma([0.5] * dims[data['di']], 0.5, {'SUMA_k': ks[data['ki']], 'verb_filenameprefix': "suma_oracle_k=%d_d=%d_f=%s_run=%d_" % (ks[data['ki']], dims[data['di']], funcs[data['fi']].__name__, data['ti'])})
